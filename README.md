...
> **Note:** The earlier Electron/Astra experiment is archived under the [`astra-archived`](https://github.com/truefrontier/nested-reader/tree/astra-archived) branch and is no longer maintained.
