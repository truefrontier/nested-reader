...
export function UpDownIcon() {
  return (
    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2.5 3.5 5 1 7.5 3.5M2.5 6.5 5 9l2.5-2.5" />
    </svg>
  );
}
...
export function CheckIcon() {
  return (
    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" stroke="var(--bg)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
...
export function GeneralIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
      ...
      <circle cx="8" cy="7" r="2.5" fill="var(--bg)" />
      <circle cx="14" cy="15" r="2.5" fill="var(--bg)" />
    </svg>
  );
}
...
export function AppearanceIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M11 3a8 8 0 0 1 0 16z" fill="currentColor" />
    </svg>
  );
}
...
export function AiIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round">
      <path d="M11 3c.6 4.6 3.4 7.4 8 8-4.6.6-7.4 3.4-8 8-.6-4.6-3.4-7.4-8-8 4.6-.6 7.4-3.4 8-8z" />
    </svg>
  );
}
